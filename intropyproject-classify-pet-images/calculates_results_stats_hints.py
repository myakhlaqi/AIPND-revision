...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_dogs_img'] = sum(results_dic[k][3] == 1 for k in results_dic)

    results_stats_dic['n_match'] = sum(1 for k in results_dic if results_dic[k][2] == 1)
    results_stats_dic['n_correct_dogs'] = sum(1 for k in results_dic if results_dic[k][3] == results_dic[k][4]==1)
    results_stats_dic['n_correct_notdogs'] = sum(1 for k in results_dic if results_dic[k][3] == results_dic[k][4]==0)
    results_stats_dic['n_correct_breed'] = sum(1 for k in results_dic if results_dic[k][3] == results_dic[k][2]==1)
    ...
    results_stats_dic['pct_match'] =  results_stats_dic['n_images'] and results_stats_dic['n_match']/results_stats_dic['n_images'] or 0
    ...
    results_stats_dic['pct_correct_dogs'] = results_stats_dic['n_dogs_img'] and results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img'] or 0
    ...
    results_stats_dic['pct_correct_breed'] = results_stats_dic['n_dogs_img'] and results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img'] or 0
